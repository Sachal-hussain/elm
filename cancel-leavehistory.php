...
<html lang="en">
   <head>
        ...
        <!-- Title -->
        <title>Admin | Cancel Leave leaves </title>
        ...
        <!-- <script>
                        $(document).ready(function() {
                            ...
                            function handleTableActions(action) {
                                ...
                                // Update button state
                                if (isAnyChecked) {
                                    $("#pendingBtn, #declineBtn, #approveBtn").prop("disabled", false);
                                } else {
                                    $("#pendingBtn, #declineBtn, #approveBtn").prop("disabled", true);
                                }
                                ...
                                if (action === 'pending' || action === 'decline' || action === 'approve') {
                            ...
                            $("#pendingBtn").click(function() {
                                handleTableActions('pending'); // Call with action 'pending'
                            });
 ...
 -->
            <script>
                ...
                function updateButtonState() {
                    let isAnyChecked = $(".leave-checkbox:checked").length > 0;
                    if (isAnyChecked) {
                        $("#pendingBtn, #approveBtn, #declineBtn").prop("disabled", false);
                    } else {
                        $("#pendingBtn, #approveBtn, #declineBtn").prop("disabled", true);
                    }
                }
                ...
                function handleTableActions(action) {
                    ...
                    if (action === 'pending' || action === 'approve' || action === 'decline') {
                        $(".leave-checkbox:checked").each(function() {
                            let row = $(this).closest("tr");
                            let leaveId = row.data('leave-id');
                            let status;
